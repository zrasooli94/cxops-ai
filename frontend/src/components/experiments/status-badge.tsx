import { experimentStatusLabel } from "@/lib/experiments/experiments";
...
const EXPERIMENT_STATUS_VARIANTS: Record<string, BadgeVariant> = {
  draft: "warning",
  ready: "info",
  running: "violet",
  completed: "success",
...
export function ExperimentStatusBadge({ status }: { status: string }) {
  return (
    <Badge variant={EXPERIMENT_STATUS_VARIANTS[status] ?? "default"}>
